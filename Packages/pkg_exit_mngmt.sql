CREATE OR REPLACE PACKAGE exit_management_pkg IS
PROCEDURE record_exit (
    ...
    -- Procedure to list exited employees with filters
PROCEDURE list_exit_employees (
    ...
    -- Procedure to display top 3 exit reasons
    PROCEDURE exit_analysis_top_3_reasons;
    

END exit_management_pkg;
/



CREATE OR REPLACE PACKAGE BODY exit_management_pkg IS
...
PROCEDURE exit_analysis_top_3_reasons IS
    v_count NUMBER := 0;
BEGIN
    DBMS_OUTPUT.PUT_LINE('---------------------------------------------');
